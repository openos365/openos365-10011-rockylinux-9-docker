# openos365-10011-rockylinux-9-docker
...
docker run -it openos365/openos365-10011-rockylinux-9-docker-main-root:latest bash
```
#### www

```
docker pull openos365/openos365-10011-rockylinux-9-docker-main-www:latest
docker run -it openos365/openos365-10011-rockylinux-9-docker-main-www:latest bash
```
